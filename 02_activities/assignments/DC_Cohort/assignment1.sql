...
SELECT vendor_id, COUNT(vendor_id) as occurrence
...
WHERE vendor_name = 'Thomass Superfood Store';
*/
...
SELECT 
	...
	c.customer_first_name,
	c.customer_last_name,
    SUM(quantity * cost_to_customer_per_qty) AS money_spent_in_April2022
